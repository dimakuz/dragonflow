...
class NbApi(object):
    ...
    def _start_subscriber(self):
        ...
        publishers = self.publisher.get_all()
    ...
    class _PublisherCRUDHelper(_CRUDHelper):
        @classmethod
        def _publisher_not_too_old(cls, publisher):
        ...
        def get_all(self, topic=None):
            publishers = super(NbApi._PublisherCRUDHelper, self).get_all(topic)
            return [p for p in publishers if self._publisher_not_too_old(p)]
