...
class FcApp(df_base_app.DFlowApp):
    ...
    def _install_flow_classifier(self, fc):
        ...
        if lport_id == fc.get_source_port_id():
    ...
    def _install_source_flow_classifier(self, fc, lport):
        ...
        action_inst = self.parser.OFPInstructionActions(
            ...
            [self.parser.OFPActionSetField(reg6=fc.get_unique_key())])
        ...
        # End-of-chain
        match = self.parser.OFPMatch(reg6=fc.get_unique_key())
    ...
    def _get_fc_lport_id(self, fc):
        return fc.get_source_port_id() or fc.get_dest_port_id()
    ...
    def update_portchain(self, pc):
        ...
        new_fcs = set(pc.get_flow_classifier_ids())
